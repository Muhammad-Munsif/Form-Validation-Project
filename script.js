        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            modalCloseBtn.addEventListener("click", handleDashboardRedirect);
            ...
            function handleDashboardRedirect() {
                ...
                if (userData) {
                    ...
                    // Update total users (simulate growth)
            ...
            function showLogin() {
                alert('In a real implementation, this would show the login form');
            }
                ...
                btn.addEventListener("click", function () {
                    const platform = this.classList.contains("google")
                        ...
                        : this.classList.contains("facebook")
                            ...
                            : "GitHub";
                    alert(
                        `In a real implementation, this would redirect to ${platform} authentication`
                    );
                });
            });
